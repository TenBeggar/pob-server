...
public enum GameMode {
    ...
    /**
     * 水晶之痕.飞升模式，5v5杀死中立生物泽拉斯的玩家获得巨大战力提升
     */
    ASCENSION,
    ...
    /**
     * 召唤师峡谷.机械攻城模式，5v5分蓝方为攻城方，红方为防守方，双方有特殊的召唤师技能
     */
    SIEGE,

    /**
     * 召唤师峡谷.血腥狩猎模式，5v5每次击杀获得1层狩猎值，3层后消耗所有狩猎值进入隐身状态
     */
    ASSASSINATE,
    ...
    /**
     * 星际守护者入侵(PVE)，5个玩家阻止虚空入侵，最后消灭峡谷先锋的模式
     */
    STARGUARDIAN,
    ...
    /**
     * 召唤师峡谷.终极魔典，开局3选1其他英雄的大招为召唤师技能
     */
    ULTBOOK,

    /**
     * 樱花模式，特定节日推出，游戏的地图和角色外观有特别设计
     */
    CHERRY,
    ;
}
